export default {
  ...
  visualization: {
    ...
    panel_view_result_tips: 'Choosing {0} will override the chart’s result display range (1~10000)',
    ...
    choose_background_tips: 'The component’s own background overrides this setting',

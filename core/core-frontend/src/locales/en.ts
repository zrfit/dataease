...
Scatter chart (bubble) chart: {a} (series name), {b} (data name), {c} (value array), {d} (none)`,
  ...
  visualization: {
    ...
    url_check_error: 'Redirect error, URL is invalid',
    ...
    mobile_style_setting_tips: 'Custom mobile background',
    board: 'Border',
    text: 'Text',
    ...
    filter_component: 'Query component',
    enable_refresh_view: 'Enable refresh',
    enable_view_loading: 'Chart loading prompt',
    ...
    target_url_tips: 'You can click on the field to splice URL or parameters',
    select_world: 'Click on the reference field',
    ...
    pic_adaptation: 'Adaptation component',
    pic_equiratio: 'Proportional adaptation',
    ...
    tab_inner_style: 'Tab internal style',
    ...
    multiplexing: 'Reuse',
    panel_off: 'Dashboard has been removed',
    batch_opt: 'Batch operation',
    cancel_batch_opt: 'Exit batch operation',
    edit_leave_tips: 'Do you want to give up editing and leave the current interface? ',
    ...
    web_set_tips: 'Some websites may not allow embedding and cannot be displayed',
    repeat_params: 'Parameters with duplicate names exist',
    enable_outer_param_set: 'Enable external parameter settings',
    select_param: 'Please select parameters...',
    add_param_link_field: 'Add parameter linkage field',
    ...
    edit_web_tips: 'Edit status cannot operate the internal web page',
    no_auth_role: 'Not shared role',
    ...
    auto_pwd: 'Automatically generate password',
    link: 'Link',
    over_time: 'Validity period',
    ...
    share: 'Share',
    remove_share_confirm: 'Confirm to cancel all sharing of the current dashboard? ',
    share_in: 'Share to me',
    share_out: 'My share',
    who_share: 'Sharer',
    ...
    groupAdd: 'Create a new directory',
    panelAdd: 'Create a new dashboard',
    delete: 'Delete',
    move_to: 'Move to',
    rename: 'Rename',
    ...
    create_public_links: 'Create public link',
    ...
    export_to_img: 'Export as image',
    export_to_app: 'Export as app',
    preview: 'Preview',
    fullscreen_preview: 'Fullscreen preview',
    new_tab_preview: 'New Tab page preview',
    ...
    pls_select_belong_to_category: 'Please select the category',
    ...
    error_data: 'Error getting data, please contact the administrator',
    ...
    redo: 'Redo',
    undo: 'Undo',
    panelNull: 'This is an empty dashboard. You can edit it to enrich the content',
    copy: 'Copy',
    paste: 'Paste',
    cut: 'Cut',
    lock: 'Lock',
    ...
    add_tab: 'Add Tab',
    open_aided_design: 'Open component auxiliary design',
    close_aided_design: 'Close component auxiliary design',
    ...
    textAlign: 'left and right alignment',
    opacity: 'opacity',
    verticalAlign: 'up and down alignment',
    text_align_left: 'left alignment',
    text_align_center: 'center left and right',
    text_align_right: 'right alignment',
    vertical_align_top: 'Top alignment',
    vertical_align_middle: 'Center alignment',
    vertical_align_bottom: 'Bottom alignment',
    border_style_solid: 'Solid line',
    border_style_dashed: 'Dash line',
    ...
    switch_picture: 'Change picture',
    select_field: 'Select chart field',
    remove_all_linkage: 'Clear all linkage',
    exit_un_march_linkage_field: 'Linkage field cannot be empty',
    details: 'Details',
    setting: 'Settings',
    no_drill_field: 'Missing association field',
    matrix: 'Matrix',
    suspension: 'Suspension',
    new_element_distribution: 'Element move distribution method',
    ...
    subject_no_edit: 'System subject cannot be modified',
    subject_name_not_null: 'Subject name requires 1~20 characters',
    is_enable: 'Enable',
    open_mode: 'Open mode',
    new_window: 'New page',
    now_window: 'Current page',
    pop_window: 'Pop-up page',
    hyperLinks: 'Target address',
    link_open_tips: 'Dashboard non-editing state can open links',
    data_loading: 'Data preparation...',
    export_loading: 'Exporting...',
    export_pdf: 'Export PDF',
    jump_set: 'Jump setting',
    enable_jump: 'Enable jump',
    column_name: 'Field name',
    enable_column: 'Enable fields',
    open_model: 'Open mode',
    link_type: 'Jump type',
    link_outer: 'External link',
    link_panel: 'Dashboard',
    select_jump_panel: 'Select the associated dashboard',
    link_view: 'Linked chart',
    link_view_field: 'Linked chart field',
    add_jump_field: 'Add jump linkage dependent fields',
    input_jump_link: 'Please enter the jump link',
    select_dimension: 'Please select the dimension...',
    select_dimension_hint: 'Please check the field you need to jump to',
    please_select: 'Please select',
    video_type: 'Video type',
    online_video: 'Online video',
    streaming_media: 'Streaming media',
    auto_play: 'Auto play',
    video_tips: 'HTTPS link is preferred; currently supported formats are mp4,webm',
    play_frequency: 'Play frequency',
    play_once: 'Play once',
    play_circle: 'Loop play',
    video_links: 'Video link',
    web_url: 'Web page address',
    ...
    be_empty_dir: 'It is an empty directory! ',
    fold: 'Collapse',
    expand: 'Expand',
    ...
    export_time: 'Export time',
    you_can_type_here: 'You can enter other content here'
  },
  link_ticket: {
    require: 'Required',

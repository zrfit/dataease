export default {
  ...
  chart: {
    ...
    table_col_freeze_tip: '凍結前 n 列',
    table_row_freeze_tip: '凍結前 n 行',
    table_freeze: '凍結',
    stripe: '斑馬紋',
    start_angle: '起始角度',
    end_angle: '結束角度',
  ...
  v_query: {
    msg_center: '消息中心',
    to_be_filled: '待填報',
    the_minimum_value: '數值區間最大值必須大于最小值',
    before_querying: '查詢條件是必填項，請設置選項值后，再進行查詢！',
    here_or_click: '將右側的字段拖拽到這里 或 點擊',
    add_query_condition: '添加查詢條件',
    set_filter_condition: '設置過濾條件',
    delete_condition: '刪除條件',
    last_3_months: '最近 3 個 月',
    last_6_months: '最近 6 個 月',
    last_12_months: '最近 12 個 月',
    last_3_days: '最近 3 天',
    month_to_date: '月初至今',
    year_to_date: '年初至今',
    exact_match: '精確匹配',
    fuzzy_match: '模糊匹配',
    option_type: '選項類型',
    time_filter_range: '設置時間篩選范圍',
    configured: '已配置',
    is_not_supported: '綁定參數后，不支持傳空數據',
    contains_empty_data: '選項值包含空數據',
    unnamed: '未命名',
    cannot_be_empty: '查詢條件或字段不能為空',
    the_first_level: '第一級無需配置被級聯字段',
    configure_cascaded_fields: '與上一級使用同一個數據集,無需配置被級聯字段',
    condition_cascade_configuration: '查詢條件級聯配置',
    not_reverse_cascade: '(僅上級能級聯下級,不可反向級聯)',
    must_be_met: '基于當前查詢組件的查詢條件，如果需要進行級聯配置，需要滿足以下條件：',
    select_data_set: '1. 展示類型：文本下拉組件和數字下拉組件；2. 選項值來源：選擇數據集',
    add_cascade_configuration: '添加級聯配置',
    add_cascade_condition: '添加級聯條件',
    query_condition_level: '查詢條件層級',
    select_query_condition: '請選擇查詢條件',
    select_cascaded_field: '請選擇被級聯字段',
    level_1: '第{msg}級',
    to_modify_it: '數據集的修改，會導致級聯配置失效，因此對應的級聯關系將被清除，確定修改嗎？',
    be_linked_first: '請先勾選需要聯動的圖表及字段',
    cannot_be_performed: '所選字段類型不一致，無法進行查詢配置',
    numerical_parameter_configuration: '數值參數配置必須配置最大值和最小值',
    format_is_inconsistent: '時間格式不一致',
    cannot_be_empty_de: '查詢條件為必填項,默認值不能為空',
    the_start_time: '結束時間必須大于開始時間!',
    and_end_time: '時間參數配置必須配置開始時間和結束時間',
    cannot_be_empty_time: '默認時間不能為空!',
    range_please_reset: '默認值超出日期篩選范圍內，請重新設置！',
    cannot_be_empty_input: '手工輸入-選項值不能為空',
    option_value_field: '請選擇數據集及選項值字段',
    the_data_set: '請選擇數據集的選項值字段',
    cannot_be_empty_name: '字段名稱不能為空',
    query_condition_setting: '查詢條件設置',
    query_condition: '查詢條件',
    chart_and_field: '選擇關聯圖表及字段',
    be_switched_to: '注意:自動模式支持同數據集自動關聯字段，可切換到',
    to_automatic_again: '自定義模式。切換到自定義模式后無法再切換為自動！',
    as_query_conditions: '脫敏字段，不能被設置為查詢條件',
    ...
    number_range: '數值區間',
    of_option_values: '選項值數量',
    tree_structure_design: '下拉樹結構設計',
    the_tree_structure: '點擊進行樹結構設計',
    ...
    query_field: '查詢字段',
    display_field: '顯示字段',
    the_sorting_field: '請選擇排序字段',
    condition_type: '條件類型',
    single_condition: '單條件',
    with_condition: '與條件',
    or_condition: '或條件',
    hide_condition_switch: '隱藏條件切換',
    cannot_be_displayed: '圖表所使用的數據集不同, 無法展示配置項',
    component_cascade_configuration: '查詢組件級聯配置',
    time_type: '時間類型',
    start_at: '開始于',
    end_at: '結束于',
    time_interval: '時間區間',
    interval_type: '區間類型',
    query_time_window: '動態查詢時間窗口',
    maximum_single_query: '單次查詢最多',
    empty_data: '空數據',
    time_selection: '時間選擇',
    select_a_field: '層級字段不能為空,請選擇字段!',
    add_level: '添加層級',
    tree_query_field: '下拉樹查詢字段',
    query_condition_width: '查詢條件寬度',
    custom_condition_style: '自定義條件樣式'
  },
  panel: {
    column_name: '字段名稱'
  },
  visualization: {
    ...
    redo: '重做',
    undo: '撤銷',
    panelNull: '這是一個空的儀表板，可以通過編輯來豐富內容',
    copy: '複製',
    paste: '粘貼',
    cut: '剪切',
    lock: '鎖定',
  ...
  sync_datasource: {
    ...
    please_input_url: '請輸入URL地址',
    please_input_port: '請輸入端口',
    please_input_be_port: '請輸入BE HTTP端口',
    please_input_be_ip: '請輸入BE IP地址',
